...
router.get("/user/nutricionista/clientes", Functions.verificaToken, (req, res) => NutricionistaController.VerClientes(req, res));
...
router.put("/user/nutricionista", Functions.verificaToken, (req, res) => NutricionistaController.AtualizarNutricionista(req, res));
